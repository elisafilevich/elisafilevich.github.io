var allPosters = [
    ...
    {
        id: 5,
        title: 'Metacognition of motor control – do we have conscious access to the details of our movements?',
    ...
    {
        id: 3,
        title: 'Relationship between metacognition of motor, visual and memory processes',
    ...
    {
        id: 2,
        title: 'The relationship between visual and motor metacognition depends on the demands of the first-order task.',
        authors: 'Arbuzova, P. Filevich, E.',
        journal: 'ASSC 23, London, Ontario',
        year: '2019',
